      ...
      <div>
        <div
          className={`flex justify-between px-20 py-6 items-center transition-all duration-500 ease-in-out ${
            isFixed
              ? "fixed top-0 left-0 w-full bg-white shadow-md z-50 transition-all duration-500 ease-in-out"
              : ""
          }`}
        >
        ...
        <div className="flex justify-center p-20">
          <div className="flex items-center justify-center bg-[#000000] pt-[3.4375rem] pl-[3.5rem] rounded-lg gap-[1.25rem] max-w-[80rem]">
            <div className="flex flex-col gap-10 justify-start">
              <div className="flex flex-col gap-4">
                <h2 className="text-left text-[3rem] font-inter font-medium leading-[3.6rem] text-white">
                  Take Your Business to the Next Level
                </h2>
                <h6 className="font-inter text-[1.125rem] font-normal leading-[1.6875rem] text-left text-white">
